...
public class VolumetricRayCasting : MonoBehaviour
{
    private const int THREAD_NUM = 32;
    ...
    void VolumetricRayCast(RenderTexture source, RenderTexture destination)
    {
        ...
        rayMarcher.Dispatch(kernelId, camera.pixelWidth / THREAD_NUM, camera.pixelHeight / THREAD_NUM, 1);
        buffer.Release();
